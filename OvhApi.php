...
** Fonctionne sous easyPhp + correction d'un problème sur les paramètres GET
**
*********************************************************************/

/*
// Config dans le script pricnipal index.php
...
define ("MODE_TEST", "0");		// Mettre à 1 pour executer ce script avec easyPhp, mettre à 0 quand c'est déployé sur l'hébergement OVH
